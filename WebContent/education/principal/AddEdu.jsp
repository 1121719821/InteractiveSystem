		...
		<div class="scd_t">
			<span><a onclick="admin01();"
				href="/InteractiveSystem/principalSelectAllTeacher.action">
					查看幼师信息 </a></span> <span class="now"><a
	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<div class="site-demo-button" style="margin-top: 20px;">
				<button class="layui-btn site-demo-layedit" data-type="content">添加教育案例</button>
			</div>
					...
					var active = {
						content : function() {
							...
							jQuery.ajax({
								...
								url : "/InteractiveSystem/prinAddEdu.action",
								type : "post",
								async : false,
								data : {
									title : $("#title").val(),
