...
<div class="t_bg">
	<div class="top top_a login-header">
		<a href="/InteractiveSystem/parentSelectTeacher.action">首页</a>| <img
...
<div class="header">
	<div class="head head_a clearfix">
		<div class="logo">
			<a href=""><img src="/InteractiveSystem/other/image/image02.png" /></a>
		</div>
		<ul class="nav clearfix">
			<li>
				<div class="li_m">
					<a href="/InteractiveSystem/parentSelectTeacher.action"> <span>信息管理</span>
						InformationManager
					</a>
				</div>
				<div class="er er_1">
					<div class="tabBox_t">
						<div class="tabBox">
							<ul class="tabNav">
								<li><a href="/InteractiveSystem/parentSelectTeacher.action">查询幼师信息</a></li>
								<li><a href="/InteractiveSystem/selectInfo.action">家庭信息管理
								</a></li>
							</ul>
							<div class="tabCont">
								<ul class="new_l clearfix">
									<li><a
										href="/InteractiveSystem/parentSelectTeacher.action"><img
			...
			<li>
				<div class="li_m">
					<a href="/InteractiveSystem/parSelectEdu.action"> <span>教育管理</span>
				...
				<div class="er er_1">
					<div class="tabBox_t">
						<div class="tabBox">
							<ul class="tabNav">
								<li><a href="/InteractiveSystem/parSelectEdu.action">查看教育案例</a></li>
							</ul>
							<div class="tabCont">
								<ul class="new_l clearfix">
									<li><a href=""><img
			...
			<li>
				<div class="li_m">
					<a href="/InteractiveSystem/parentSelectMessage.action"> <span>通知管理</span>
						NotificationManager
					</a>
				</div>
				<div class="er er_1">
					<div class="tabBox_t">
						<div class="tabBox">
							<ul class="tabNav">
								<li><a href="/InteractiveSystem/parentSelectMessage.action">查看班级通知</a></li>
								<li><a href="/InteractiveSystem/parentMessage.action">给幼师留言
								</a></li>
							</ul>
							<div class="tabCont">
								<ul class="new_l clearfix">
